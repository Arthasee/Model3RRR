...
TODO - Bien expliquer la façon dont on optimise l'orientation de theta_e avec la méthode  (optimize_orientation). L'idée étant de s'éloigner le plus possible des configurations de droites concourantes, en évitant les collisions (avec la méthode check_collision et segment_distance).
