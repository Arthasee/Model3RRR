...
TODO - expliquer comment fonctionne la méthode interpolate$\_$path (chaque fonction "trace" crée les points, et la fonction interpolate$\_$path crée des points entre chaque pour interpoler la trajectoire avec n$\_$steps points)
