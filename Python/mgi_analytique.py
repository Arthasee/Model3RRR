...
def mgi_analytique(eff):
    ...
    th_eff = array([[rot_eff[0][0], rot_eff[0][1], transl[0]], [rot_eff[1][0], rot_eff[1][1], transl[1]], [0, 0, 1]])
    ...
    for i in range(3):
        ...
        th = array([[rot[0][0], rot[0][1], RB*cos(ang2[i])], [rot[1][0], rot[1][1], RB*sin(ang2[i])], [0, 0, 1]])
